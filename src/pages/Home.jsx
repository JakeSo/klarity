    ...
    <div className='mt-16 md:mt-0'>
        ...
        <div className='section flex flex-wrap min-h-full w-full'>
          <div className='w-full h-full px-4 py-10 md:px-10 mb-28 md:w-2/3 text-center my-auto'>
            ...
            <h1 className='text-8xl pb-10'>HELPING RESTAURANTS THRIVE IN AN EVER-EVOLVING INDUSTRY</h1>
          </div>
        ...
        <div className="section text-center p-28">
        ...
        <div id='Contact' className='section flex flex-wrap'>
          <div className='w-full h-full p-10 md:w-1/2 md:h-2/3 my-28 text-center'>
            {/* <img src={logo} alt="Klarity logo" className='mx-auto w-24 py-10'></img> */}
            <h1 className='uppercase pb-12'>Let&apos;s take your restaurant to the <span className='text-gold'>highest level</span>!</h1>
            <h2 className="text-3xl pb-12">Klarity aims to offer owners a sense of assurance by ensuring that their restaurant team is committed to their success. Our goal is to eliminate those sleepless nights by:</h2>
            <ul id="goalsList" className="list-disc list-inside text-2xl py-4">
            ...
            <h3 className='text-3xl my-12'>Contact us today to schedule a consultation. Let&apos;s work together to unlock the full potential of your business and create unforgettable experiences for your guests.</h3>
